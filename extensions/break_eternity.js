...
class BrEt {
    ...
    blocks: [
      {
        ...
        opcode: 'fromcomp',
        blockType: 'reporter',
        text: Scratch.translate('create a number with sign:[N1]  layer:[N2]  magnitude:[N3]'),
        arguments: { N1: {type: 'number'}, N2: {type: 'number'}, N3: {type: 'number'} }
      }, {
        opcode: 'fromme',
        blockType: 'reporter',
        text: Scratch.translate('create a number with mantissa:[N1]  exponent:[N2]'),
      ...
      }, '---',
      {
        opcode: 'tcomp',
        blockType: 'reporter',
        text: Scratch.translate('compare [N1] and [N2] with [N3] of tolerance'),
      ...
      }, '---',
      {
        ...
        opcode: 'tetrate_2',
        blockType: 'reporter',
        text: Scratch.translate('[N1] ^^ [N2]  |  payload:[N3],  linearly?:[N4]'),
        ...
        opcode: 'itexp_2',
        blockType: 'reporter',
        text: Scratch.translate('ln of [N1], [N2] times  |  payload:[N3],  linearly?:[N4]'),
        arguments: { N1: {type: 'string'}, N2: {type: 'string'}, N3: {type: 'string'}, N4: {type: 'Boolean'} }
      }, {
        opcode: 'itlog_2',
        blockType: 'reporter',
        text: Scratch.translate('log of [N1] base [N2], [N3] times  |  linearly?:[N4]'),
        arguments: { N1: {type: 'string'}, N2: {type: 'string'}, N3: {type: 'string'}, N4: {type: 'Boolean'} }
      }, {
        opcode: 'slog_2',
        blockType: 'reporter',
        text: Scratch.translate('superlog of [N1] base [N2]  |  iterations:[N3],  linearly?:[N4]'),
        arguments: { N1: {type: 'string'}, N2: {type: 'string'}, N3: {type: 'number'}, N4: {type: 'Boolean'} }
      }, {
        opcode: 'plog_2',
        blockType: 'reporter',
        text: Scratch.translate('pentalog of [N1] base [N2]  |  iterations:[N3],  linearly?:[N4]'),
        arguments: { N1: {type: 'string'}, N2: {type: 'string'}, N3: {type: 'number'}, N4: {type: 'Boolean'} }
      }, 
      '---', {
        opcode: '_',
      ...
      }, '---',
      {
        opcode: 'buygeom',
        blockType: 'reporter',
        text: Scratch.translate('amount obtainble with [N1] resource, where price starts at [N2] exponentially scaled by [N3] while already owning [N4]'),
        arguments: { N1: {type: 'string'}, N2: {type: 'string'}, N3: {type: 'string'}, N4: {type: 'string'} }
      }, {
        opcode: 'sumgeom',
        blockType: 'reporter',
        text: Scratch.translate('resources needed to obtain [N1] thing, where price starts at [N2] exponentially scaled by [N3] while already owning [N4]'),
        arguments: { N1: {type: 'string'}, N2: {type: 'string'}, N3: {type: 'string'}, N4: {type: 'string'} }
      }, {
        opcode: 'buylin',
        blockType: 'reporter',
        text: Scratch.translate('amount obtainble with [N1] resource, where price starts at [N2] linearly scaled by [N3] while already owning [N4]'),
        arguments: { N1: {type: 'string'}, N2: {type: 'string'}, N3: {type: 'string'}, N4: {type: 'string'} }
      }, {
        opcode: 'sumlin',
        blockType: 'reporter',
        text: Scratch.translate('resources needed to obtain [N1] thing, where price starts at [N2] linearly scaled by [N3] while already owning [N4]'),
        arguments: { N1: {type: 'string'}, N2: {type: 'string'}, N3: {type: 'string'}, N4: {type: 'string'} }
      }, {
        opcode: 'buyeff',
        blockType: 'reporter',
        text: Scratch.translate('efficiency of a purchase costing [N1] resources, which increases your resource/sec by [N2], from [N3]'),
        arguments: { N1: {type: 'string'}, N2: {type: 'string'}, N3: {type: 'string'} }
      }, 
    ],
  ...
  ht({N1, N2}) {return (new Decimal(N1)).gt(N2)}
  hteq({N1, N2}) {return (new Decimal(N1)).gte(N2)}
  ...
  buygeom({N1, N2, N3, N4}) {
    ...
    return Decimal.floor((D1).div(v).mul(D3.sub(1)).add(1).log10().div(D3.log10())).toString()
  }
  ...
  sumgeom({N1, N2, N3, N4}) {
    ...
    let D3 = new Decimal(N3)
    let D4 = new Decimal(N4)
    return D2.mul(D3.pow(D4)).mul(Decimal.sub(1, D3.pow(D1))).div(Decimal.sub(1, D3)).toString()
  }
  ...
  buylin({N1, N2, N3, N4}) {
    ...
    let b2 = b.pow(2)
    return b.neg().add(b2.add(D3.mul(D1).mul(2)).sqrt()).div(D3).floor().toString()
  }
  ...
  sumlin({N1, N2, N3, N4}) {
    ...
    let D4 = new Decimal(N4)
    let a = D2.add(D4.mul(D3))
    return D1.div(2).mul(a.mul(2).plus(D1.sub(1).mul(D3))).toString()
  }
