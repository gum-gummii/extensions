...
class BrEt {
  getInfo() {return {
    ...
    blocks: [
      {
        opcode: 'tonumber',
        blockType: 'reporter',
        text: 'Convert [N1] to Number',
        arguments: { N1: {type: 'string'} }
      }, {
        opcode: 'fromcomp',
        blockType: 'reporter',
        text: 'create a number with sign:[N1]  layer:[N2]  magnitude:[N3]',
        arguments: { N1: {type: 'number'}, N2: {type: 'number'}, N3: {type: 'number'} }
      }, {
        opcode: 'fromme',
        blockType: 'reporter',
        text: 'create a number with mantissa:[N1]  exponent:[N2]',
      ...
      }, '---',
      {
        opcode: 'comp',
        blockType: 'reporter',
        text: 'compare [N1] and [N2]',
        arguments: { N1: {type: 'string'}, N2: {type: 'string'} }
      }, {
        opcode: 'compabs',
        blockType: 'reporter',
        text: 'abs compare [N1] and [N2]',
        arguments: { N1: {type: 'string'}, N2: {type: 'string'} }
      }, {
        opcode: 'isnan',
        blockType: 'Boolean',
      ...
      },
      {
        opcode: '_',
        blockType: 'label',
        text: 'Tolerance Comparators'
      }, '---',
      {
        opcode: 'tcomp',
        blockType: 'reporter',
        text: 'compare [N1] and [N2] with [N3] of tolerance',
        arguments: { N1: {type: 'string'}, N2: {type: 'string'}, N3: {type: 'string'} }
      }, {
        opcode: 'teq',
        blockType: 'Boolean',
        text: '[N1] = [N2] with [N3] of tolerance',
        arguments: { N1: {type: 'string'}, N2: {type: 'string'}, N3: {type: 'string'} }
      }, {
        opcode: 'tneq',
        blockType: 'Boolean',
      ...
      }, '---',
      {
        ...
        blockType: 'reporter',
        text: '[N1] of [N2]',
        arguments: { N1: {type: 'string', menu: 'smthofMenu'}, N2: {type: 'string'} }
      }, {
        opcode: 'add',
        blockType: 'reporter',
        text: '[N1] + [N2]',
        ...
        opcode: 'log',
        blockType: 'reporter',
        text: 'log of [N1] with base [N2]',
        arguments: { N1: {type: 'string'}, N2: {type: 'string'} }
      },
      '---', {
        opcode: '_',
        blockType: 'label',
        text: 'Super Operators'
      }, '---',
      {
        opcode: 'tetrate',
        blockType: 'reporter',
        ...
        opcode: 'itexp',
        blockType: 'reporter',
        text: 'ln of [N1], [N2] times',
        arguments: { N1: {type: 'string'}, N2: {type: 'string'} }
      }, {
        opcode: 'itlog',
        blockType: 'reporter',
        text: 'log of [N1] base [N2], [N3] times',
        arguments: { N1: {type: 'string'}, N2: {type: 'string'}, N3: {type: 'string'} }
      }, {
        opcode: 'slog',
        blockType: 'reporter',
        text: 'superlog of [N1] base [N2]',
        arguments: { N1: {type: 'string'}, N2: {type: 'string'} }
      }, {
        opcode: 'plog',
        blockType: 'reporter',
        text: 'pentalog of [N1] base [N2]',
        arguments: { N1: {type: 'string'}, N2: {type: 'string'} }
      }, {
        opcode: 'sroot',
        blockType: 'reporter',
        text: 'linear super root of [N1] base [N2]',
        arguments: { N1: {type: 'string'}, N2: {type: 'string'} }
      }, {
        opcode: 'proot',
        blockType: 'reporter',
        text: 'linear penta root of [N1] base [N2]',
        arguments: { N1: {type: 'string'}, N2: {type: 'string'} }
      }, {
        opcode: 'ssqrt',
        blockType: 'reporter',
        text: 'linear super square root of [N1]',
        arguments: { N1: {type: 'string'} }
      }, {
        opcode: 'tetrate_2',
        blockType: 'reporter',
        text: '[N1] ^^ [N2]  |  payload:[N3],  linearly?:[N4]',
        arguments: { N1: {type: 'string'}, N2: {type: 'string'}, N3: {type: 'string'}, N4: {type: 'Boolean'} }
      }, {
        opcode: 'pentate_2',
        blockType: 'reporter',
        text: '[N1] ^^^ [N2]  |  payload:[N3],  linearly?:[N4]',
        ...
        opcode: 'itexp_2',
        blockType: 'reporter',
        text: 'ln of [N1], [N2] times  |  payload:[N3],  linearly?:[N4]',
        arguments: { N1: {type: 'string'}, N2: {type: 'string'}, N3: {type: 'string'}, N4: {type: 'Boolean'} }
      }, {
        opcode: 'itlog_2',
        blockType: 'reporter',
        text: 'log of [N1] base [N2], [N3] times  |  linearly?:[N4]',
        arguments: { N1: {type: 'string'}, N2: {type: 'string'}, N3: {type: 'string'}, N4: {type: 'Boolean'} }
      }, {
        opcode: 'slog_2',
        blockType: 'reporter',
        text: 'superlog of [N1] base [N2]  |  iterations:[N3],  linearly?:[N4]',
        arguments: { N1: {type: 'string'}, N2: {type: 'string'}, N3: {type: 'number'}, N4: {type: 'Boolean'} }
      }, {
        opcode: 'plog_2',
        blockType: 'reporter',
        text: 'pentalog of [N1] base [N2]  |  iterations:[N3],  linearly?:[N4]',
        arguments: { N1: {type: 'string'}, N2: {type: 'string'}, N3: {type: 'number'}, N4: {type: 'Boolean'} }
      }, 
      '---', {
        opcode: '_',
        blockType: 'label',
        text: 'Number Limiters'
      }, '---',
      {
        opcode: 'max',
        blockType: 'reporter',
        text: 'max between [N1] and [N2]',
        arguments: { N1: {type: 'string'}, N2: {type: 'string'} }
      }, {
        opcode: 'min',
        blockType: 'reporter',
        text: 'min between [N1] and [N2]',
        arguments: { N1: {type: 'string'}, N2: {type: 'string'} }
      }, {
        opcode: 'maxabs',
        blockType: 'reporter',
        text: 'abs max between [N1] and [N2]',
        arguments: { N1: {type: 'string'}, N2: {type: 'string'} }
      }, {
        opcode: 'minabs',
        blockType: 'reporter',
        text: 'abs min between [N1] and [N2]',
        arguments: { N1: {type: 'string'}, N2: {type: 'string'} }
      }, {
        opcode: 'clamp',
        blockType: 'reporter',
        text: 'clamp [N1] between [N2] and [N3]',
        arguments: { N1: {type: 'string'}, N2: {type: 'string'}, N3: {type: 'string'} }
      },
      '---', {
        opcode: '_',
      ...
      }, '---',
      {
        opcode: 'buygeom',
        blockType: 'reporter',
        text: 'amount obtainble with [N1] resource, where price starts at [N2] exponentially scaled by [N3] while already owning [N4]',
        arguments: { N1: {type: 'string'}, N2: {type: 'string'}, N3: {type: 'string'}, N4: {type: 'string'} }
      }, {
        opcode: 'sumgeom',
        blockType: 'reporter',
        text: 'resources needed to obtain [N1] thing, where price starts at [N2] exponentially scaled by [N3] while already owning [N4]',
        arguments: { N1: {type: 'string'}, N2: {type: 'string'}, N3: {type: 'string'}, N4: {type: 'string'} }
      }, {
        opcode: 'buylin',
        blockType: 'reporter',
        text: 'amount obtainble with [N1] resource, where price starts at [N2] linearly scaled by [N3] while already owning [N4]',
        arguments: { N1: {type: 'string'}, N2: {type: 'string'}, N3: {type: 'string'}, N4: {type: 'string'} }
      }, {
        opcode: 'sumlin',
        blockType: 'reporter',
        text: 'resources needed to obtain [N1] thing, where price starts at [N2] linearly scaled by [N3] while already owning [N4]',
        arguments: { N1: {type: 'string'}, N2: {type: 'string'}, N3: {type: 'string'}, N4: {type: 'string'} }
      }, {
        opcode: 'buyeff',
        blockType: 'reporter',
        text: 'efficiency of a purchase costing [N1] resources, which increases your resource/sec by [N2], from [N3]',
        arguments: { N1: {type: 'string'}, N2: {type: 'string'}, N3: {type: 'string'} }
      }, 
    ],
    ...
    menus: {
      smthofMenu: {
        ...
        items: [
          'abs', 'neg', 'round', 'floor', 'ceil', 'truncated', 'reciprocal', 'factorial', 'gamma', 'positive log10',
          'abs log10', 'log10', 'log2', 'natural log', 'pow10', 'square', 'cube', 'exp', 'sqrt', 'cbrt',
      ...
      numbers: {
        acceptReporters: true,
        items: [
          'one', 'two', 'zero', 'negOne', 'ten', 'nan', 'inf'
        ]
      }
    }
  }}
  ...
  tonumber({N1}) {return (new Decimal(N1)).toNumber()}
  fromcomp({N1, N2, N3}) {return (new Decimal()).fromComponents(N1, N2, N3).toString()}
  fromme({N1, N2}) {return (new Decimal()).fromMantissaExponent(N1, N2).toString()}
  comp({N1, N2}) {return (new Decimal(N1)).cmp(N2)}
  compabs({N1, N2}) {return (new Decimal(N1)).cmpabs(N2)}

  isnan({N1}) {return (new Decimal(N1)).isNan()}
  isfinite({N1}) {return (new Decimal(N1)).isFinite()}

  eq({N1, N2}) {return (new Decimal(N1)).eq(N2)}
  neq({N1, N2}) {return (new Decimal(N1)).neq(N2)}
  lt({N1, N2}) {return (new Decimal(N1)).lt(N2)}
  lteq({N1, N2}) {return (new Decimal(N1)).lte(N2)}
  ht({N1, N2}) {return (new Decimal(N1)).ht(N2)}
  hteq({N1, N2}) {return (new Decimal(N1)).hte(N2)}


  tcomp({N1, N2, N3}) {return (new Decimal(N1)).cmp_tolerance(N2, N3)}
  teq({N1, N2, N3}) {return (new Decimal(N1)).eq_tolerance(N2, N3)}
  tneq({N1, N2, N3}) {return (new Decimal(N1)).neq_tolerance(N2, N3)}
  tlt({N1, N2, N3}) {return (new Decimal(N1)).lt_tolerance(N2, N3)}
  tlteq({N1, N2, N3}) {return (new Decimal(N1)).lte_tolerance(N2, N3)}
  tht({N1, N2, N3}) {return (new Decimal(N1)).gt_tolerance(N2, N3)}
  thteq({N1, N2, N3}) {return (new Decimal(N1)).gte_tolerance(N2, N3)}


  smthof({N1, N2}) {
    let x = new Decimal(N2)
    if (N1 == 'abs') {return x.abs().toString()}
    else if (N1 == 'neg') {return x.neg().toString()}
    else if (N1 == 'round') {return x.round().toString()}
    else if (N1 == 'floor') {return x.floor().toString()}
    else if (N1 == 'ceil') {return x.ceil().toString()}
    else if (N1 == 'truncated') {return x.trunc().toString()}
    else if (N1 == 'reciprocal') {return x.recip().toString()}
    else if (N1 == 'factorial') {return x.factorial().toString()}
    else if (N1 == 'gamma') {return x.gamma().toString()}
    else if (N1 == 'positive log10') {return x.pLog10().toString()}
    else if (N1 == 'abs log10') {return x.absLog10().toString()}
    else if (N1 == 'log10') {return x.log10().toString()}
    else if (N1 == 'log2') {return x.log2().toString()}
    else if (N1 == 'natural log') {return x.ln().toString()}
    else if (N1 == 'pow10') {return x.pow10().toString()}
    else if (N1 == 'square') {return x.sqr().toString()}
    else if (N1 == 'cube') {return x.pow(3).toString()}
    else if (N1 == 'exp') {return x.exp().toString()}
    else if (N1 == 'sqrt') {return x.sqrt().toString()}
    else if (N1 == 'cbrt') {return x.cbrt().toString()}
    else if (N1 == 'sin') {return x.sin().toString()}
    else if (N1 == 'cos') {return x.cos().toString()}
    else if (N1 == 'tan') {return x.tan().toString()}
    else if (N1 == 'asin') {return x.asin().toString()}
    else if (N1 == 'acos') {return x.acos().toString()}
    else if (N1 == 'atan') {return x.atan().toString()}
    else if (N1 == 'sinh') {return x.sinh().toString()}
    else if (N1 == 'cosh') {return x.cosh().toString()}
    else if (N1 == 'tanh') {return x.tanh().toString()}
    else if (N1 == 'asinh') {return x.asinh().toString()}
    else if (N1 == 'acosh') {return x.acosh().toString()}
    else if (N1 == 'atanh') {return x.atanh().toString()}
    else return x
  }
  add({N1, N2}) {return (new Decimal(N1)).add(N2).toString()}
  sub({N1, N2}) {return (new Decimal(N1)).sub(N2).toString()}
  div({N1, N2}) {return (new Decimal(N1)).div(N2).toString()}
  mul({N1, N2}) {return (new Decimal(N1)).mul(N2).toString()}
  mod({N1, N2}) {return (new Decimal(N1)).mod(N2).toString()}
  log({N1, N2}) {return (new Decimal(N1)).log(N2).toString()}
  pow({N1, N2}) {return (new Decimal(N1)).pow(N2).toString()}
  root({N1, N2}) {return (new Decimal(N1)).root(N2).toString()}

  max({N1, N2}) {return (new Decimal(N1)).max(N2).toString()}
  min({N1, N2}) {return (new Decimal(N1)).min(N2).toString()}
  maxabs({N1, N2}) {return (new Decimal(N1)).maxabs(N2).toString()}
  minabs({N1, N2}) {return (new Decimal(N1)).minabs(N2).toString()}
  clamp({N1, N2, N3}) {return (new Decimal(N1)).clamp(N2, N3).toString()}


  tetrate({N1, N2}) {return (new Decimal(N1)).tetrate(N2).toString()}
  tetrate_2({N1, N2, N3, N4}) {return (new Decimal(N1)).tetrate(N2, N3, N4).toString()}
  pentate({N1, N2}) {return (new Decimal(N1)).pentate(N2).toString()}
  pentate_2({N1, N2, N3, N4}) {return (new Decimal(N1)).pentate(N2, N3, N4).toString()}
  itexp({N1, N2}) {return (new Decimal(N1)).iteratedexp(N2).toString()}
  itexp_2({N1, N2, N3, N4}) {return (new Decimal(N1)).iteratedexp(N2, N3, N4).toString()}
  itlog({N1, N2, N3}) {return (new Decimal(N1)).iteratedlog(N2, N3).toString()}
  itlog_2({N1, N2, N3, N4}) {return (new Decimal(N1)).iteratedlog(N2, N3, N4).toString()}
  slog({N1, N2}) {return (new Decimal(N1)).slog(N2).toString()}
  slog_2({N1, N2, N3, N4}) {return (new Decimal(N1)).slog(N2, N3, N4).toString()}
  plog({N1, N2}) {return (new Decimal(N1)).penta_log(N2).toString()}
  plog_2({N1, N2, N3, N4}) {return (new Decimal(N1)).penta_log(N2, N3, N4).toString()}

  sroot({N1, N2}) {return (new Decimal(N1)).linear_sroot(N2).toString()}
  proot({N1, N2}) {return (new Decimal(N1)).linear_penta_root(N2).toString()}
  ssqrt({N1}) {return (new Decimal(N1)).ssqrt().toString()}

  buygeom({N1, N2, N3, N4}) {return (new Decimal()).affordGeometricSeries(N1, N2, N3, N4)}
  sumgeom({N1, N2, N3, N4}) {return (new Decimal()).sumGeometricSeries(N1, N2, N3, N4)}
  buylin({N1, N2, N3, N4}) {return (new Decimal()).affordArithmeticSeries(N1, N2, N3, N4)}
  sumlin({N1, N2, N3, N4}) {return (new Decimal()).sumArithmeticSeries(N1, N2, N3, N4)}
  buyeff({N1, N2, N3}) {return (new Decimal()).efficiencyOfPurchase(N1, N2, N3)}
}
...
//menus: {MENU: {acceptReporters: true, items: ['a', 'b']} }